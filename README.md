...
1. Omniverse SmartFarm OmniOps 실행
2. Baseline으로 현재 딸기 상태 확인
3. `Generate Gemma/RAG Blueprints` 클릭
4. Plan A/B/C 후보와 score 확인
5. RAG Trace panel에서 실제 호출/근거 확인
6. 추천 Plan 적용
7. Growth Camera로 딸기 view 확인
